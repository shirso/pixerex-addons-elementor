...
class Maps extends WPML_Elementor_Module_With_Items {
	...
	protected function get_title( $field ) {
        ...
        if ( 'map_latitude' === $field ) {
			return __( 'Maps: Marker Latitude', 'pixerex-elements' );
		}
        if ( 'map_longitude' === $field ) {
			return __( 'Maps: Marker Longitude', 'pixerex-elements' );
		}
        if ( 'pin_title' === $field ) {
			return __( 'Maps: Marker Title', 'pixerex-elements' );
		}
        if ( 'pin_desc' === $field ) {
			return __( 'Maps: Marker Description', 'pixerex-elements' );
		}
