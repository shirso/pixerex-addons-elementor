...
namespace PixerexElements\Includes\Templates;
    ...
    class Pixerex_Templates {
        ...
        */
        private function load_files() {
            ...
            require PIXEREX_ELEMENTS_PATH . 'includes/templates/classes/config.php';
            
            require PIXEREX_ELEMENTS_PATH . 'includes/templates/classes/assets.php';
            
            require PIXEREX_ELEMENTS_PATH . 'includes/templates/classes/manager.php';

            require PIXEREX_ELEMENTS_PATH . 'includes/templates/types/manager.php';

            require PIXEREX_ELEMENTS_PATH . 'includes/templates/classes/api.php';
