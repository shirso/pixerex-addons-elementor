...
class Pixerex_Card extends Widget_Base {
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            '_section_image',
            [
                'label' => __( 'Image & Badge', 'pixerex-elements' ),
        ...
        $this->add_control(
            'image_position',
            [
                'label' => __( 'Image Position', 'pixerex-elements' ),
        ...
        $this->add_control(
            'badge_text',
            [
                'label' => __( 'Badge Text', 'pixerex-elements' ),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => __( 'Badget Text', 'pixerex-elements' ),
                'placeholder' => __( 'Type badge text', 'pixerex-elements' ),
                'separator' => 'before',
                'description' => __( 'Set badget position and control all the style settings from Style tab', 'pixerex-elements' ),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'type' => Controls_Manager::TEXT,
                'default' => __( 'Happy Card Title', 'pixerex-elements' ),
                'placeholder' => __( 'Type Card Title', 'pixerex-elements' ),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'description' => Helper_Functions::ha_get_allowed_html_desc( 'intermediate' ),
                'type' => Controls_Manager::TEXTAREA,
                'default' => __( 'Happy card description goes here', 'pixerex-elements' ),
                'placeholder' => __( 'Type card description', 'pixerex-elements' ),
                'rows' => 5,
                'dynamic' => [
                    'active' => true,
                ]
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'default' => 'Button Text',
                'placeholder' => __( 'Type button text here', 'pixerex-elements' ),
                'label_block' => true,
                'dynamic' => [
                    'active' => true,
                ]
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'before' => [
                        'title' => __( 'Before', 'pixerex-elements' ),
                        'icon' => 'eicon-h-align-left',
                    ],
                    'after' => [
                        'title' => __( 'After', 'pixerex-elements' ),
                        'icon' => 'eicon-h-align-right',
                    ],
                ],
                'default' => 'before',
        ...
        <div class="ha-card-body">
            ...
            if ( $settings['title' ] ) :
                printf( '<%1$s %2$s>%3$s</%1$s>',
                    ...
                    Helper_Functions::ha_kses_basic( $settings['title' ] )
                );
            endif;
            ?>
            ...
            <?php if ( $settings['description'] ) : ?>
                <div <?php echo $this->get_render_attribute_string( 'description' ); ?>>
                    <p><?php echo Helper_Functions::ha_kses_intermediate( $settings['description'] ); ?></p>
                </div>
            <?php endif; ?>
