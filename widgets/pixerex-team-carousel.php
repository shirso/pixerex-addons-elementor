...
class Pixerex_Team_Carousel extends Base {
    protected $templateInstance;
    public function getTemplateInstance() {
        return $this->templateInstance = Includes\pixerex_Template_Tags::getInstance();
    }
    public function get_title() {
        return sprintf( '%1$s %2$s', Helper_Functions::get_prefix(), __('Team Carousel', 'pixerex-elements') );
    }
    public function get_icon() {
        return 'px px-team-carousel';
    }
    public function get_style_depends() {
        return ['pixerex-slick','pixerex-slick-theme','pixerex-elements','pixerex-team-carousel-element'];
    }
    public function get_script_depends() {
        return ['pixerex-elements-js','pixerex-slick-js','pixerex-team-carousel-js'];
    }
    protected function _register_controls() {
        $this->start_controls_section(
            '_section_info',
            [
                'label' => __( 'Information', 'pixerex-elements' ),
        ...
        $repeater->add_control(
            'image',
            [
                'label' => __( 'Photo', 'pixerex-elements' ),
        ...
        $repeater->add_control(
            'title',
            [
                'label' => __( 'Name', 'pixerex-elements' ),
                'label_block' => true,
                'type' => Controls_Manager::TEXT,
                'default' => __( 'Happy Member Name', 'pixerex-elements' ),
                'placeholder' => __( 'Type Member Name', 'pixerex-elements' ),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $repeater->add_control(
            'job_title',
            [
                'label' => __( 'Job Title', 'pixerex-elements' ),
                'label_block' => true,
                'type' => Controls_Manager::TEXT,
                'default' => __( 'Happy Officer', 'pixerex-elements' ),
                'placeholder' => __( 'Type Member Job Title', 'pixerex-elements' ),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $repeater->add_control(
            'bio',
            [
                'label' => __( 'Short Bio', 'pixerex-elements' ),
                'type' => Controls_Manager::TEXTAREA,
                'placeholder' => __( 'Write something amazing about the happy member', 'pixerex-elements' ),
                'rows' => 5,
                'dynamic' => [
                    'active' => true,
                ]
        ...
        $repeater->add_control(
            'show_options',
            [
                'label' => __( 'Show Options', 'pixerex-elements' ),
        ...
        $repeater->add_control(
            'website', [
                'label_block' => false,
                'type' => Controls_Manager::TEXT,
                'label' => __( 'Website Address', 'pixerex-elements' ),
                'placeholder' => __( 'Add your profile link', 'pixerex-elements' ),
                'input_type' => 'url',
                'condition' => [
                    'show_options' => 'yes'
                ],
        ...
        $repeater->add_control(
            'email', [
                'label_block' => false,
                'type' => Controls_Manager::TEXT,
                'label' => __( 'Email', 'pixerex-elements' ),
                'placeholder' => __( 'Add your Email address', 'pixerex-elements' ),
                'input_type' => 'email',
                'condition' => [
                    'show_options' => 'yes'
                ],
        ...
        $repeater->add_control(
            'facebook', [
                'label_block' => false,
                'type' => Controls_Manager::TEXT,
                'label' => __( 'Facebook', 'pixerex-elements' ),
                'placeholder' => __( 'Add your Facebook address', 'pixerex-elements' ),
                'input_type' => 'url',
                'condition' => [
                    'show_options' => 'yes'
                ],
        ...
        $repeater->add_control(
            'twitter', [
                'label_block' => false,
                'type' => Controls_Manager::TEXT,
                'label' => __( 'Twitter', 'pixerex-elements' ),
                'placeholder' => __( 'Add your Twitter address', 'pixerex-elements' ),
                'input_type' => 'url',
                'condition' => [
                    'show_options' => 'yes'
                ],
        ...
        $repeater->add_control(
            'instagram', [
                'label_block' => false,
                'type' => Controls_Manager::TEXT,
                'label' => __( 'Instagram', 'pixerex-elements' ),
                'placeholder' => __( 'Add your Instagram address', 'pixerex-elements' ),
                'input_type' => 'url',
                'condition' => [
                    'show_options' => 'yes'
                ],
        ...
        $repeater->add_control(
            'github', [
                'label_block' => false,
                'type' => Controls_Manager::TEXT,
                'label' => __( 'Github', 'pixerex-elements' ),
                'placeholder' => __( 'Add your Github address', 'pixerex-elements' ),
                'input_type' => 'url',
                'condition' => [
                    'show_options' => 'yes'
                ],
        ...
        $repeater->add_control(
            'linkedin', [
                'label_block' => false,
                'type' => Controls_Manager::TEXT,
                'label' => __( 'LinkedIn', 'pixerex-elements' ),
                'placeholder' => __( 'Add your LinkedIn address', 'pixerex-elements' ),
                'input_type' => 'url',
                'condition' => [
                    'show_options' => 'yes'
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'title' => __( 'Happy Member Name', 'pixerex-elements' ),
                        'job_title' => __( 'Happy Officer', 'pixerex-elements' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'h1'  => [
                        'title' => __( 'H1', 'pixerex-elements' ),
                        'icon' => 'eicon-editor-h1'
                    ],
                    'h2'  => [
                        'title' => __( 'H2', 'pixerex-elements' ),
                        'icon' => 'eicon-editor-h2'
                    ],
                    'h3'  => [
                        'title' => __( 'H3', 'pixerex-elements' ),
                        'icon' => 'eicon-editor-h3'
                    ],
                    'h4'  => [
                        'title' => __( 'H4', 'pixerex-elements' ),
                        'icon' => 'eicon-editor-h4'
                    ],
                    'h5'  => [
                        'title' => __( 'H5', 'pixerex-elements' ),
                        'icon' => 'eicon-editor-h5'
                    ],
                    'h6'  => [
                        'title' => __( 'H6', 'pixerex-elements' ),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'justify' => [
                        'title' => __( 'Justify', 'pixerex-elements' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'label_off' => __( 'No', 'pixerex-elements' ),
                'return_value' => 'yes',
                'description' => __( 'Best works with odd number of slides (Slides To Show) and loop (Infinite Loop)', 'pixerex-elements' ),
                'frontend_available' => true,
                'style_transfer' => true,
            ]
        );
        ...
        $this->add_responsive_control(
            'slides_to_show',
            [
                'label' => __( 'Slides To Show', 'pixerex-elements' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    1 => __( '1 Slide', 'pixerex-elements' ),
                    2 => __( '2 Slides', 'pixerex-elements' ),
                    3 => __( '3 Slides', 'pixerex-elements' ),
                    4 => __( '4 Slides', 'pixerex-elements' ),
                    5 => __( '5 Slides', 'pixerex-elements' ),
                    6 => __( '6 Slides', 'pixerex-elements' ),
                ],
                'desktop_default' => 3,
                'tablet_default' => 3,
                'mobile_default' => 2,
        ...
        $this->end_controls_section();
        $this->start_controls_section(
            'pixerex_section_team_carousel_item_style',
            [
                'label' => __( 'Carousel Item', 'pixerex-elements' ),
        ...
        $this->add_responsive_control(
            'item_spacing',
            [
                'label' => __( 'Space Between items', 'pixerex-elements' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', '%'],
                'range' => [
                    '%' => [
        ...
        $this->end_controls_section();
        $this->start_controls_section(
            'pixerex_section_team_carousel_image_style',
            [
                'label' => __( 'Photo', 'pixerex-elements' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        ...
        $this->end_controls_section();
        $this->start_controls_section(
            'pixerex_section_team_carousel_content_style',
            [
                'label' => __( 'Name, Job Title & Bio', 'pixerex-elements' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_responsive_control(
        ...
        $this->end_controls_section();
        $this->start_controls_section(
            'pixerex_section_team_carousel_social_style',
            [
                'label' => __( 'Social Icons', 'pixerex-elements' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_responsive_control(
            'links_spacing',
            [
                'label' => __( 'Right Spacing', 'pixerex-elements' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'selectors' => [
        ...
        $this->end_controls_section();
        $this->start_controls_section(
            'pixerex_section_team_carousel_arrow_style',
            [
        ...
        $this->add_control(
            'arrow_sync_position',
            [
                'label' => __( 'Sync Position', 'pixerex-elements' ),
                'type' => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options' => [
                    'yes' => [
                        'title' => __( 'Yes', 'pixerex-elements' ),
                        'icon' => 'eicon-sync',
                    ],
                    'no' => [
                        'title' => __( 'No', 'pixerex-elements' ),
        ...
        $this->add_responsive_control(
            'arrow_spacing',
            [
                'label' => __( 'Space between Arrows', 'pixerex-elements' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'condition' => [
                    'arrow_position_toggle' => 'yes',
        ...
        $this->start_controls_section(
            'pixerex_section_team_carousel_dots_style',
            [
