...
if ( ! class_exists( 'Pixerex_Templates_Types' ) ) {
	...
	class Pixerex_Templates_Types {
        ...
        /**
         * Pixerex_Templates_Types constructor.
         *
		...
		public function register_types() {
			...
			$base_path = PIXEREX_ELEMENTS_PATH . 'includes/templates/types/';

			require $base_path . 'base.php';

			$temp_types = array(
				__NAMESPACE__ . '\Pixerex_Structure_Section' => $base_path . 'section.php',
			);
