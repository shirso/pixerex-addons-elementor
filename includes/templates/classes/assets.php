...
namespace PixerexElements\Includes\Templates\Classes;

use PixerexElements\Includes\Templates;

if( ! defined( 'ABSPATH' ) ) exit; // No access of directly access

if( ! class_exists('Pixerex_Templates_Assets') ) {
     ...
     * 
     */
    class Pixerex_Templates_Assets {
        ...
        /**
        * Pixerex_Templates_Assets constructor.
        *
        ...
        */
        ...
        public function editor_styles() {
            ...
            wp_enqueue_style(
                ...
                PIXEREX_ELEMENTS_URL . 'assets/editor/templates/css/editor' . $is_rtl . '.css',
                array(),
        ...
        public function enqueue_preview_styles() {
            ...
            wp_enqueue_style(
                'pa-preview',
                PIXEREX_ELEMENTS_URL . 'assets/editor/templates/css/preview' . $is_rtl . '.css', 
                array(),
                PIXEREX_ELEMENTS_VERSION,
                'all'
            );
        ...
        public function editor_scripts() {
            ...
            wp_enqueue_script(
				...
				PIXEREX_ELEMENTS_URL . 'assets/editor/templates/js/editor.js',
				array(
                    'jquery',
                    'underscore',
                    'backbone-marionette'
        ...
        public function load_footer_scripts() {
            ...
            $scripts = glob( PIXEREX_ELEMENTS_PATH . 'includes/templates/scripts/*.php' );
