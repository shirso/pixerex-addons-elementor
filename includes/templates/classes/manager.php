...
if ( ! class_exists( 'Pixerex_Templates_Manager' ) ) {
     ...
     * 
     */
	class Pixerex_Templates_Manager {
        ...
        /**
         * Pixerex_Templates_Manager constructor.
         *
		...
		public function register_sources() {
			...
			require PIXEREX_ELEMENTS_PATH . 'includes/templates/sources/base.php';

            $namespace = str_replace( 'Classes', 'Sources' , __NAMESPACE__ );
            
			$sources = array(
				'premium-api'   =>  $namespace . '\Pixerex_Templates_Source_Api',
			);

			foreach ( $sources as $key => $class ) {
                
				require PIXEREX_ELEMENTS_PATH . 'includes/templates/sources/' . $key . '.php';
