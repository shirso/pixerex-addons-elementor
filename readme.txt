...
* [**Facebook Group**](https://www.facebook.com/groups/PixerexElements/) A great place to get help or ask a question about Premium Addons.
...
- Fixed: `Uncaught ArgumentCountError: Too few arguments to function PixerexElements\Widgets\Pixerex_Blog::get_post_thumbnail()` in Premium Blog widget
...
- Fixed: `Notice: Undefined index: pixerex_modal_box_button_icon_selection` in Modal Box.
...
- Fixed: `Notice: Undefined variable: col_number in /pixerex-blog.php on line 1752'
...
- Fixed: class `PixerexElements\Pixerex_Addons_Integration` does not have a method `pixerex_maps_required_script`
...
- Fixed: Notice: Undefined property: PixerexElements\Plugin::$settings
...
- Fixed: Warning "Cannot redeclare control with same name pixerex_gallery_img_alt".
...
- Fixed: 'Undefined index: pixerex_dual_header_second_header_tag' in Premium Dual Heading widget.
...
- Fix: Fatal error: Class 'PixerexElements\Helper_Functions' not found. 
