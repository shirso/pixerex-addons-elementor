...
namespace PixerexElements\Includes;
...
/**
* pixerex_Templat_Tags class defines all the query of options of select box
* 
* Setting up the helper assets of the pixerex widgets
*
* @since 1.0
*/

class pixerex_Template_Tags {
