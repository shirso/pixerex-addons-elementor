...
class Pixerex_Image_Compare extends Base {
    ...
    public function get_title() {
        return sprintf( '%1$s %2$s', Helper_Functions::get_prefix(), __('Image Compare', 'pixerex-elements') );
    }

    public function get_icon() {
        return 'px px-image-compare';
    }
    public function get_style_depends() {
        return ['pixerex-twentytwenty','pixerex-elements','pixerex-image-compare-element'];
    }
    public function get_script_depends() {
        return ['pixerex-elements-js','pixerex-event-move-js','pixerex-twentytwenty-js','pixerex-image-compare-js'];
    }
    protected function _register_controls() {
        ...
        $this->start_controls_tab(
            '_tab_before_image',
            [
                'label' => __( 'Before', 'pixerex-elements' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __( 'Before', 'pixerex-elements' ),
                'placeholder' => __( 'Type before image label', 'pixerex-elements' ),
                'description' => __( 'Label will not be shown if Hide Overlay is enabled in Settings', 'pixerex-elements' ),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $this->start_controls_tab(
            '_tab_after_image',
            [
                'label' => __( 'After', 'pixerex-elements' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Label', 'pixerex-elements' ),
                'type' => Controls_Manager::TEXT,
                'default' => __( 'After', 'pixerex-elements' ),
                'placeholder' => __( 'Type after image label', 'pixerex-elements' ),
                'description' => __( 'Label will not be shown if Hide Overlay is enabled in Settings', 'pixerex-elements' ),
                'dynamic' => [
                    'active' => true,
                ]
        ...
        $this->add_control(
            'offset',
            [
                'label' => __( 'Visibility Ratio', 'pixerex-elements' ),
        ...
        $this->add_control(
            'orientation',
            [
                'label' => __( 'Orientation', 'pixerex-elements' ),
                'type' => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options' => [
                    'horizontal' => [
                        'title' => __( 'Horizontal', 'pixerex-elements' ),
                        'icon' => 'fa fa-arrows-h',
                    ],
                    'vertical' => [
                        'title' => __( 'Vertical', 'pixerex-elements' ),
                        'icon' => 'fa fa-arrows-v',
                    ],
                ],
                'default' => 'horizontal',
        ...
        $this->add_control(
            'hide_overlay',
            [
                'label' => __( 'Hide Overlay', 'pixerex-elements' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __( 'Yes', 'pixerex-elements' ),
                'label_off' => __( 'No', 'pixerex-elements' ),
                'return_value' => 'yes',
                'description' => __( 'Hide overlay with before and after label', 'pixerex-elements' ),
                'style_transfer' => true,
            ]
        );
        ...
        $this->add_control(
            'move_handle',
            [
                'label' => __( 'Move Handle', 'pixerex-elements' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'on_swipe',
                'options' => [
                    'on_hover' => __( 'On Hover', 'pixerex-elements' ),
                    'on_click' => __( 'On Click', 'pixerex-elements' ),
                    'on_swipe' => __( 'On Swipe', 'pixerex-elements' ),
                ],
                'description' => __( 'Select handle movement type. Note: overlay does not work with On Hover.', 'pixerex-elements' ),
                'style_transfer' => true,
            ]
        );
        ...
        $this->end_controls_section();
        $this->start_controls_section(
            'pixerex_section_handle_style',
            [
                'label' => __( 'Handle', 'pixerex-elements' ),
        ...
        $this->add_control(
            '_heading_bar',
            [
                'label' => __( 'Handle Bar', 'pixerex-elements' ),
        ...
        $this->add_control(
            '_heading_arrow',
            [
                'label' => __( 'Handle Arrow', 'pixerex-elements' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_responsive_control(
            'arrow_box_width',
            [
                'label' => __( 'Box Width', 'pixerex-elements' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px' ],
                'range' => [
                    'px' => [
        ...
        $this->add_responsive_control(
            'arrow_box_height',
            [
                'label' => __( 'Box Height', 'pixerex-elements' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px' ],
                'range' => [
                    'px' => [
    ...
    protected static function get_data_settings( $settings ) {
        ...
        return Helper_Functions::prepare_data_prop_settings( $settings, $field_map );
    }
