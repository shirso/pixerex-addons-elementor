...
class Pixerex_Image_Scroll extends Widget_Base {
    ...
    public function get_title() {
		return sprintf( '%1$s %2$s', Helper_Functions::get_prefix(), __('Image Scroll', 'pixerex-elements') );
    }
    ...
    protected function _register_controls() {
		...
		$this->start_controls_section('general_settings',
            [
                'label'         => __('Image Settings', 'pixerex-elements')
            ]
        );
		...
		$this->add_control('image',
			[
                'label'         => __('Image', 'pixerex-elements'),
					...
					'description'   => __('Choose the scroll image', 'pixerex-elements' ),
					'label_block'   => true
			]
        );
		...
		$this->add_responsive_control('image_height',
            [
                'label'         => __('Image Height', 'pixerex-elements'),
        ...
        $this->add_control('link_switcher', 
            [
                ...
                'description'   => __('Add a custom link or select an existing page link','pixerex-elements'),
            ]
        );
        ...
        $this->add_control('direction_type',
            [
                ...
                'description'	 => __( 'Select Scroll Direction', 'pixerex-elements' ),
                'type'			 => Controls_Manager::SELECT,
                'options'		 => [
        ...
        $this->add_control('reverse',
            [
                'label'			=> __( 'Reverse Direction', 'pixerex-elements' ),
                'type'			=> Controls_Manager::SWITCHER,
                'condition'     => [
                    'trigger_type' => 'hover',
                ]
        ...
        $this->add_control('trigger_type', 
            [
                ...
                'options'       => [
                    ...
                    'scroll'  => __('Mouse Scroll', 'pixerex-elements'),
                ],
                'default'       => 'hover',
            ]
        );
        ...
        $this->add_control('duration_speed',
            [
                'label'			=> __( 'Speed', 'pixerex-elements' ),
                'description'	=> __( 'Set the scroll speed value. The value will be counted in seconds (s)', 'pixerex-elements' ),
        ...
        $this->add_control('overlay',
            [
                'label'         => __('Overlay','pixerex-elements'),
                'type'          => Controls_Manager::SWITCHER,
